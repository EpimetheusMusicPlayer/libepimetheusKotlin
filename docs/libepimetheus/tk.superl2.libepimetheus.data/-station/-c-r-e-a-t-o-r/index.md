[libepimetheus](../../../index.md) / [tk.superl2.libepimetheus.data](../../index.md) / [Station](../index.md) / [CREATOR](./index.md)

# CREATOR

`companion object CREATOR : `[`Creator`](https://developer.android.com/reference/android/os/Parcelable/Creator.html)`<`[`Station`](../index.md)`>`
